/*
*       Tests have Passed will have to set it up with your own database to test for yourself.
*
...
suite('Functional Tests', function() {
    ...
    suite('GET /api/stock-prices => stockData object', function() {
      ...
      //test one is set for goog (google stock price, likes and stock data)
      ...
      //make sure to reset or this wont work as already has past like 
...
test('1 stock with like again (ensure likes arent double counted)', function(done) {
  ...
  .end(function(err, res){
    assert.equal(res.body, 'Error: Only 1 Like per IP Allowed')
      ...
      //testing the 2 stock function with amazon and apple
